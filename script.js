...
function latitude_Longitude(latitude, longitude) {
  latilongiRef.innerHTML = `<span id="latgap">Latitude : ${latitude.toFixed(6)}</span> <span id="longgap">Longitude : ${longitude.toFixed(6)}</span>`;
  MapBoxRef.src = `https://maps.google.com/maps?q=${latitude}, ${longitude}&z=18&output=embed`;
}
